...
export default function GamersArcLanding() {
  ...
  return (
    <main
      id="main-content"
      tabIndex={-1}
      className="gamers-arc-landing min-h-screen"
    >
      <WaitingListModal
        open={waitlistOpen}
        ...
        <div className="nav-brand">
          ...
          <div className="logo-box">
            <img
              src={
                theme === "dark"
                  ? "/icons/Gamers-Arc-white.png"
                  : "/icons/Gamers-Arc.png"
              }
              alt="Gamers Arc Logo"
      ...
      <section className="hero">
        ...
        <div className="hero-inner">
          <div className="hero-eyebrow">
            <span className="eye-dot"></span> The Arena Is Live — Are You Ready?
          </div>
          ...
          <p className="hero-sub">
            GamersArc is where <strong>real skill meets real money</strong>.
            Challenge rivals, enter tournaments, build your squad, and turn
            every match into an opportunity to win big.
          </p>
          <div className="hero-btns">
            <a href="#challenge" className="btn btn-gold">
              <span className="icon">⚔️</span> Challenge a Gamer
            </a>
            <a href="#tournaments" className="btn btn-red">
              <span className="icon">🏆</span> Enter Tournament
            </a>
            <a href="#teams" className="btn btn-ghost">
              <span className="icon">🛡️</span> Find Your Team
            </a>
          </div>
          ...
          <div className="challenge-layout">
            <div>
              ...
              <p className="section-body">
                Think you&apos;re the best? Prove it. Send a cash challenge to
                any gamer on the platform — you set the stakes, you set the
                game. Every match is a chance to add to your wallet. No luck.
                Pure skill. Pure earnings.
              </p>
              ...
              <div style={{ marginTop: "2.5rem" }}>
                ...
                >
                  <span className="icon">⚔️</span> Issue a Challenge
                </a>
              </div>
            </div>
        ...
        <div className="section-wrap">
          <div className="tournament-layout">
            <div>
              ...
              <p className="section-body">
                From weekly cups to grand championship events — GamersArc hosts
                tournaments with prize pools that scale with every registration.
                The bigger the crowd, the bigger the crown. You&apos;ve trained
                for this moment.
              </p>
              <div className="morale-box" style={{ marginTop: "2rem" }}>
                <div className="morale-quote">
                  &ldquo;Every legend started as a <span>challenger</span>. Your
                  title is waiting.&rdquo;
                </div>
              ...
              <div style={{ marginTop: "2rem" }}>
                <a
                  ...
                  onClick={handlePlayNowClick}
                >
                  <span className="icon">🏆</span> Browse All Tournaments
                </a>
              </div>
            </div>
        ...
        <div className="section-wrap">
          <div className="teams-layout">
            <div>
              ...
              <p className="section-body">
                Solo warriors become legends. But legends become dynasties with
                the right squad. Create or join a team, build your reputation,
                and compete in team-based tournaments for even bigger prizes.
                Your crew is your greatest weapon.
              </p>
              <div className="teams-perks">
                <div className="perk">
                  <span className="perk-icon">🛡️</span>
                  <p className="perk-text">
                    <strong>Create Your Own Team</strong> — Build a brand,
                    design your tag, recruit the best players on the platform.
                  </p>
                </div>
                <div className="perk">
                  <span className="perk-icon">🔍</span>
                  <p className="perk-text">
                    <strong>Smart Team Matching</strong> — Our system finds
                    squads that fit your playstyle, game, and skill level.
                  </p>
                </div>
                <div className="perk">
                  <span className="perk-icon">📊</span>
                  <p className="perk-text">
                    <strong>Team Leaderboards</strong> — Climb the ranks
                    together. Top teams earn sponsor visibility and exclusive
                    challenges.
                  </p>
                </div>
                <div className="perk">
                  <span className="perk-icon">💰</span>
                  <p className="perk-text">
                    <strong>Shared Prize Pools</strong> — Win as a team, cash
                    out as a team. Every member gets their cut, instantly.
                  </p>
                </div>
              </div>
              <div style={{ marginTop: "2rem" }}>
                <a
                  ...
                  onClick={handlePlayNowClick}
                >
                  <span className="icon">🛡️</span> Browse Teams
                </a>
                &nbsp;&nbsp;
                <a
                  href="#"
                  ...
                  onClick={handlePlayNowClick}
                >
                  <span className="icon">➕</span> Create a Team
                </a>
              </div>
            </div>
            <div>
      ...
      <div className="morale-banner">
        <div className="morale-center">
          <h2 className="morale-headline">
            ...
            <br />
            <span className="gold">To Only Come</span>{" "}
            <span className="outline">This Far.</span>
          </h2>
          <p className="morale-p">
            Every top player on GamersArc was once where you are now — one match
            away from something great. The difference between average and
            legendary is one decision:{" "}
            <strong style={{ color: "var(--white)" }}>
              showing up and playing to win.
            </strong>
          </p>
          <a
            href="#"
            ...
            onClick={handlePlayNowClick}
          >
            <span className="icon">🚀</span> Start Your Arc Today
          </a>
        </div>
      </div>
          ...
          <div className="steps">
            <div className="step">
              ...
              <div className="step-desc">
                Sign up in 60 seconds. Link your gaming accounts and set your
                primary game to match you with the right competition.
              </div>
            </div>
            <div className="step">
              <div className="step-icon">💳</div>
              ...
              <div className="step-desc">
                Add funds securely. Your earnings stay in your wallet until
                you&apos;re ready to cash out — no lock-ins, ever.
              </div>
            </div>
            <div className="step">
              ...
              <div className="step-desc">
                Issue a 1v1 challenge, register for a tournament, or join an
                existing team looking for your skills.
              </div>
            </div>
            <div className="step">
              <div className="step-icon">🏆</div>
              ...
              <div className="step-desc">
                Victory means instant payout. Withdraw to your bank, mobile
                money, or crypto wallet — it&apos;s your money.
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="sponsors-section">
        <div className="sponsors-inner">
          <div className="sponsors-label">
            Trusted Partners & Sponsors — <em>Your logo could be here</em>
          </div>
          ...
          <div className="footer-top">
            <div>
              ...
              <p className="footer-tagline">
                The competitive gaming platform where skill earns real rewards.
                Play, win, repeat.
              </p>
            </div>
            <div>
