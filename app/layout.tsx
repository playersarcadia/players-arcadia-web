  ...
  return (
    <html lang="en" className="bg-gray-50 scroll-smooth">
      <body className="bg-gray-50">
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[100] focus:px-4 focus:py-2 focus:bg-[#082C73] focus:text-white focus:rounded-lg focus:outline-none focus:ring-2 focus:ring-[#d4af37]"
        >
        ...
        <ErrorBoundary>
          <div className="mx-4 sm:mx-6 md:mx-8 lg:mx-10 xl:mx-12 min-h-screen bg-white">
            <Header />
            <main className="pt-16 sm:pt-18 md:pt-20 lg:pt-22 xl:pt-24" id="main-content" role="main" tabIndex={-1}>
              {children}
            </main>
          </div>
        </ErrorBoundary>
